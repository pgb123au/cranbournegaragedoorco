"""Bulk find/replace + page rename for Cranbourne Garage Door Co & Pergolas scaffold."""
...
REPLACEMENTS = [
    ("https://geelongroofrestorations.com.au", "https://cranbournegaragedoorco.com.au"),
    ("geelongroofrestorations.com.au", "cranbournegaragedoorco.com.au"),
    ("geelongroofrestorations", "cranbournegaragedoorco"),
    ("Geelong Roof Restorations", "Cranbourne Garage Door Co &amp; Pergolas"),
    ("Geelong roof restoration", "Cranbourne decking &amp; pergola"),
    ("Geelong&rsquo;s specialist", "Cranbourne&rsquo;s specialist"),
    ("Geelong&rsquo;s", "Cranbourne&rsquo;s"),
    ...
    ("Geelong, the Bellarine and the Surf Coast", "Cranbourne, Narre Warren and the Endeavour Hills Hills"),
    ("Geelong, the Bellarine, and the Surf Coast", "Cranbourne, Narre Warren, and the Endeavour Hills Hills"),
    ...
    ("/services/roof-painting/", "/services/garage-door-repair/"),
    ("/services/tile-restoration/", "/services/motor-replacement/"),
    ...
    ("Armstrong Creek", "Emerald"),
    ("Lara", "Hampton Park"),
    ("quotes@geelongroofrestorations.com.au", "quotes@cranbournegaragedoorco.com.au"),
    (">G</text>", ">P</text>"),
]
...
def main():
    ...
    for old, new in [
        ...
        ("lara.astro", "cranbourne-upper.astro"),
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "geelongroofrestorations"', '"name": "cranbournegaragedoorco"')
