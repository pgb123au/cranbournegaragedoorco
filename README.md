# Cranbourne Garage Door Co &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `cranbournegaragedoorco.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://cranbournegaragedoorco.netlify.app |
...
├── pages/
│   ├── index.astro           # home (Cranbourne primary)
...
├── whisper.js                # "Pete's Lead from Cranbourne Garage Door Co &amp; Pergolas" played to contractor before patching caller through
...
| Telnyx TeXML app | `CranbourneRetainingWalls-Voicemail` (id `2955788144311535476`) |
...
| `TENANT_BRAND` | `Cranbourne Garage Door Co &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Cranbourne Garage Door Co &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:cranbournegaragedoorco.com.au`).
4. Set up Google Business Profile (needs registered business name "Cranbourne Garage Door Co &amp; Pergolas" first).
5. Backlink work: hipages directory, True Local AU, Yelp AU, City of Casey community pages.
6. Shortlist 2–3 retaining wall contractors in Cranbourne; pitch the leads with a $1,500–$2,500/mo exclusive retainer.

## Niche-fit notes

| Factor | Why this niche |
|---|---|
| Local fit | Cranbourne/Cockatoo estates are sloped — demand is structural, not weather-cyclical |
